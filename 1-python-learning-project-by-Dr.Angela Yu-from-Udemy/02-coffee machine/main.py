...
def is_resources_sufficient(oder_ingredients):
    """Return the True or False by checking resources """
    is_enough = True
...
def is_transaction_succesful(money_recieve, drink_cost):
    """Return True if sufficient money, False if it's not"""
...
def make_coffee(drink_name, order_ingredients):
    """Deduct the required in gredients from resources"""
...
# but they only inserted $0.52
# then after counting the coins the program should say “​Sorry that's not enough money. Money refunded.​”.
# b. But if the user has inserted enough money, then the cost of the drink gets added to the machine as the profit
# and this will be reflected the next time “report” is triggered. E.g. Water: 100ml
# Milk: 50ml
# Coffee: 76g
#Money: $2.5
